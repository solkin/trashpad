...
<html>
  ...
  <body data-spy="scroll" data-target=".bs-docs-sidebar">
        ...
        <div class="container" >
          ...
          <form class="navbar-search pull-right form-search" action="./">
            <div class="input-append">
              <input type="text" class="search-query" placeholder="<? echo _("Search") ?>" name="query"/>
    ...
    if ($random) {
      ...
      echo '<button class="span3 offset3 btn btn-large btn-info" type="submit" id="big_green_button">' . _("One more random") . '</button> ';
      echo '</form>';
    } else if ($thread_id || empty($threads_list)) {
      echo '<form class="form-inline" action="./" method="post">';
      echo '<button class="span3 offset3 btn btn-large btn-success" type="submit" id="big_green_button">' . _("To other threads") . '</button> ';
      echo '</form>';
    }
